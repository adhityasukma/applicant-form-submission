 ...
 */
class Applicant_Form_Submission {
	 ...
	 * @since    0.0.1
	 * @access   protected
	 * @var      Applicant_Form_Submission_Loader    $loader    Maintains and registers all hooks for the plugin.
	 */
	protected $loader;
	...
	public function __construct() {
		...
		$this->plugin_name = 'applicant-form-submission';
	 ...
	 *
	 * - Applicant_Form_Submission_Loader. Orchestrates the hooks of the plugin.
	 * - Applicant_Form_Submission_i18n. Defines internationalization functionality.
	 * - Applicant_Form_Submission_Admin. Defines all hooks for the admin area.
	 * - Applicant_Form_Submission_Public. Defines all hooks for the public side of the site.
	 *
	 ...
	 *
	 * Uses the Applicant_Form_Submission_i18n class in order to set the domain and to register the hook
	 * with WordPress.
	 *
	 * @since    0.0.1
	 * @access   private
	...
	private function set_locale() {
		...
		$plugin_i18n = new Applicant_Form_Submission_i18n();
	...
	private function define_admin_hooks() {
		...
		$plugin_admin = new Applicant_Form_Submission_Admin( $this->get_plugin_name(), $this->get_version() );
	...
	private function define_public_hooks() {
		...
		$plugin_public = new Applicant_Form_Submission_Public( $this->get_plugin_name(), $this->get_version() );
	 ...
	 *
	 * @since     0.0.1
	 * @return    Applicant_Form_Submission_Loader    Orchestrates the hooks of the plugin.
	 */
